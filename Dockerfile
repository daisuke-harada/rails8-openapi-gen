...
# docker build -t enman_api .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name enman_api enman_api
...
# Force bundler to build native gems from source (avoid platform precompiled gem mismatches)
